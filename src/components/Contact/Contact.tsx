...
const Contact = () => {
  return (
    <section
      id="contact"
      className="relative py-20 overflow-hidden bg-primary-light dark:bg-bg-dark"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start mt-16">
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-2">
                    <label className="text-text-muted-dark dark:text-gray-300 text-xs font-medium uppercase tracking-wider">
                      Your Name
                    </label>
                    <input
                      type="text"
                      placeholder="John Doe"
                      className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-text-main-dark dark:text-white placeholder:text-gray-400 focus:border-primary/50 focus:ring-1 focus:ring-primary/30 outline-none transition-all duration-300"
                    />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-text-muted-dark dark:text-gray-300 text-xs font-medium uppercase tracking-wider">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="resize-none bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-4 text-text-main-dark dark:text-white placeholder:text-gray-400 focus:border-primary/50 focus:ring-1 focus:ring-primary/30 outline-none transition-all duration-300"
                  />
                </div>
          ...
          <div className="lg:pt-10 space-y-12">
            <div className="space-y-8">
              <h4 className="text-xl font-semibold text-text-main-dark dark:text-text-main">
                Contact Information
              </h4>
