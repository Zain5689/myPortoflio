  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-6 text-center">
      <div className="relative mb-8">
        <AlertTriangle
          size={100}
          className="text-primary animate-pulse drop-shadow-[0_0_15px_rgba(95,45,237,0.3)"
        />
      ...
      <Link
        to="/"
        className="flex items-center gap-3 bg-primary text-black font-bold px-8 py-4 rounded-2xl hover:bg-primary-dark hover:shadow-[0_0_30px_rgba(95,45,237,0.3)] transition-all duration-300 group"
      >
        <Home
          size={20}
